(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".gallery__slider")) {
                ...
                function gallerySliderFix() {
                    ...
                    if (diff > 0) {
                        gallerySlider.style.width = "";
                        gallerySlider.style.width = gallerySlider.offsetWidth + diff + 15 + "px";
                        console.log(`if ${gallerySlider.style.width}`);
                    } else {
                        gallerySlider.style.width = "";
                        gallerySlider.style.width = gallerySlider.offsetWidth + 15 + "px";
                        console.log(`else ${gallerySlider.style.width}`);
                    }
                }
        ...
        function bgParallax() {
            ...
            if (bgItems.length) window.addEventListener("scroll", (e => {
                bgItems.forEach((bgItem => {
                    ...
                    if (bgItemBg) {
                        ...
                        if (scrollY > bgItemPosition - window.innerHeight && scrollY < bgItemPosition + bgItemHeight) bgItemBg.style.cssText = `transform: translate3d(0px,${bgItemPositionValue}px,0px)`;
                    }
                }));
            }));
        }
...
***************************************************************************** */
        ...
        window.addEventListener("load", (e => {
            ...
            if (document.querySelector(".video-module")) {
                ...
                document.querySelector(".video-module").addEventListener("click", (e => {
                    const videoModule = document.querySelector(".video-module");
                    const videoModuleClasses = videoModule.classList;
                    const video = videoModule.querySelector("video");
                    if (!videoModuleClasses.contains("_init")) {
                        videoModuleClasses.add("_active");
                        videoModuleClasses.add("_init");
                        video.src = video.dataset.full;
                        video.play();
                        video.muted = false;
                    } else {
                        video.paused ? video.play() : video.pause();
                        videoModuleClasses.toggle("_active");
                    }
                }));
            }
        }));
